...
Title="C-Dogs ." Desc="C-Dogs is a classic overhead run-and-gun game" porter="Christian_Haitian" locat="C-Dogs.zip" runtype="rtr"
...
Title="DiverDown ." Desc="Diver Down is a stealth-platformer. Avoid the lights on 20 different stages using your mysterious Diver Down ability, that allows you to dive onto solids! ." porter="Cebion" locat="diverdown.zip" runtype="rtr"
...
Title="Fallout_1 ." Desc="Fallout is a post nuclear RPG.  You need to copy critter.dat, master.dat and data from the original game to ports/fallout1 folder." porter="Kloptops" locat="Fallout1.zip"
...
Title="Sonic_Mania ." Desc="Sonic the Hedgehog Mania decompilation by Rubberduckycooly.  Just add your own android Data.rsdk file to the ports/sonicmania folder.  See the wiki for more info on this" porter="TheGammaSqueeze" locat="Sonic%20Mania.zip"
...
Title="Starcatcher ." Desc="Starcatcher is a platformer inspired by Kirby, Metroid, Gravitron Experiment. Your goal: Collect stars in outer space." porter="Cebion" locat="starcatcer.zip" runtype="rtr"
...
Title="Ultimate_Tapan_Kaikki ." Desc="A simple top-down shooter.  Just download and play." porter="Cebion" locat="ultimatetapankaikki.zip" runtype="rtr"
